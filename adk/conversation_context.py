...
try:
    ...
    from .prior_items import get_prior_reference_items, is_describe_prior_items_query
    from .session_commerce import parse_tiles_from_text, session_active_product
except ImportError:
    from product_matcher import (
        AUDIENCE_KEYWORDS,
        CATEGORY_KEYWORDS,
...
def _tv():
    try:
        from .tile_validator import find_catalog_product, product_to_tile, rebuild_response_with_tiles
    except ImportError:
        from tile_validator import find_catalog_product, product_to_tile, rebuild_response_with_tiles
...
def conversation_context_hint(
    ...
    *,
    ...
    if is_follow_up_continuation(user_query) and prev_browse:
        ...
        try:
            from .browse_filters import get_session_filters
        except ImportError:
            from browse_filters import get_session_filters
