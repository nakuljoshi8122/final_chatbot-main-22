...
try:
    from .adidas_catalog import build_marketplace_document, flatten_catalog
    from .product_images import resolve_image_url
except ImportError:
    from adidas_catalog import build_marketplace_document, flatten_catalog
    from product_images import resolve_image_url
...
def get_marketplace(brand: str = "Adidas") -> dict:
...
def seed_marketplace(brand: str = "Adidas") -> int:
