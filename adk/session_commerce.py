...
try:
    from .product_matcher import find_products_by_mention, get_product_by_id
    from .tile_validator import TILES_REGEX, product_to_tile, find_catalog_product
except ImportError:
    from product_matcher import find_products_by_mention, get_product_by_id
    from tile_validator import TILES_REGEX, product_to_tile, find_catalog_product

CHECKOUT_URL = "https://www.adidas.co.in/cart"
...
def set_active_product(session_id: str, product_id: str) -> Optional[dict]:
    ...
    try:
        from .session_store import save_active_product_id
    except ImportError:
        from session_store import save_active_product_id
...
def update_session_from_response(session_id: str, response_text: str) -> None:
    try:
        from .conversation_context import record_shown_tiles
    except ImportError:
        from conversation_context import record_shown_tiles
...
def resolve_product_for_add(
    ...
    try:
        from .conversation_context import resolve_single_product_for_commerce
    except ImportError:
        from conversation_context import resolve_single_product_for_commerce
...
def add_to_cart(session_id: str, tile: dict) -> bool:
    ...
    try:
        from .session_store import persist_cart_from_memory
    except ImportError:
        from session_store import persist_cart_from_memory
